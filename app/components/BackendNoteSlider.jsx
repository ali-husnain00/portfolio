            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm leading-snug">
                  The backend of full stack projects in this portfolio is hosted on free platforms, so initial load may take a few seconds. Functionality and code quality are fully implemented.
                </p>
              </div>
            </div>
          </motion.aside>
